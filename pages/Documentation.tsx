...
const Documentation: React.FC = () => {
    ...
    const documentationStructuredData = {
        ...
        "@graph": [
            {
                "@type": "WebPage",
                "@id": `${SITE_URL}/documentation#webpage`,
                "url": `${SITE_URL}/documentation`,
                "name": "BSOD Documentation - Crash Dump Analysis Guide",
                ...
                "step": [
                    {
                        ...
                        "url": `${SITE_URL}/documentation#finding-files`,
                        "image": IMAGES.ogImage
                    },
                    {
                        "@type": "HowToStep",
    ...
    return (
        <>
            ...
            />
            <StructuredData data={documentationStructuredData} />
