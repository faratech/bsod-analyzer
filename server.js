...
app.use((req, res, next) => {
  ...
  // Inline script hashes (2 scripts: Google Analytics + AdSense loaders)
  // Generated: 2025-11-12 via: cd dist && node -e "..." | grep sha256
  const cspDirectives = [
    "default-src 'self'",
    // CRITICAL: Script integrity enforcement
    // - 'self': Allow scripts from same origin
    // - sha256-RWA8...: Google Analytics loader (681 bytes)
    // - sha256-2VQJf...: Google AdSense loader (439 bytes)
    ...
    "script-src 'self' 'sha256-RWA8jI/uFfWen/ekOMi+NeuSYbHluNaBnLBf1tUwjiU=' 'sha256-2VQJflc88vDyEr9Oqj+VE8fl1/5C81468wfjPMURqgM=' https://*.cloudflare.com https://static.cloudflareinsights.com https://*.google https://*.google.com https://*.googletagmanager.com https://*.googlesyndication.com https://adnxs.com",
